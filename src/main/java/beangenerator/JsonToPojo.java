...
public class JsonToPojo {
	...
	public static void main(String[] args) {
		...
		File inputJson = new File("C:\\software\\microservicesKubernetes\\CodeGenerator\\src\\com\\response.json");
		File outputPojoDirectory = new File("C:\\software\\microservicesKubernetes\\CodeGenerator\\src\\com");
